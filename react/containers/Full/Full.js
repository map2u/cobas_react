...
class Full extends Component {
  ...
  fetchMenuItems() {
    var that = this;
      fetch('http://localhost:8040/sidebar_items').then(function (response) {
        return response.json();
      }).then(function (result) {
        that.setState({ menu_items: result.data.menu_items });
     console.log(that.state.menu_items);
    ...
    return (
      <div className="app">
        ...
        <div className="app-body">
          <Sidebar {...this.props} menu_items={this.state.menu_items}/>
          <main className="main">
