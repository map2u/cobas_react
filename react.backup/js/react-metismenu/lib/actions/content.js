...
var changeMenuSpanVisibility = exports.changeMenuSpanVisibility = function changeMenuSpanVisibility(reduxUid, id, trace, menuSpanVisibility) {
   console.log("menuSpanVisibility="+menuSpanVisibility);
 return {
    type: 'CHANGE_MENUSPAN_VISIBILITY',
    reduxUid: reduxUid,
    id: id,
    trace: trace,
    menuSpanVisibility: menuSpanVisibility
  };
};
