...
var Container = function Container(_ref, _ref2) {
  ...
  return _react2.default.createElement(
    'ul',
    {
      className: (0, _classnames2.default)(typeof classStore.classContainer === 'function' ? classStore.classContainer({ itemId: itemId, visible: visible, menuSpanVisibility: menuSpanVisibility, items: items }) : classStore.classContainer, menuSpanVisibility?'collapsed':'',visible && classStore.classContainerVisible)
    },
    items.map(function (item, i) {
        return _react2.default.createElement(_Item2.default, _extends({ key: item.id || '_' + i, reduxStoreName: reduxStoreName, menuSpanVisibility: menuSpanVisibility,reduxUid: reduxUid }, item));
     })
  );
};
