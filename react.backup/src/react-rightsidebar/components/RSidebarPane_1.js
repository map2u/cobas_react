...
var RSidebarPane = function (_React$Component) {
  _inherits(RSidebarPane, _React$Component);

  function RSidebarPane(props) {
    _classCallCheck(this, RSidebarPane);

    var _this = _possibleConstructorReturn(this, (RSidebarPane.__proto__ || Object.getPrototypeOf(RSidebarPane)).call(this, props));
...
RSidebarPane.childContextTypes = {
