...
var mapDispatchToProps = exports.mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
  return {
    toggleMenuSpan: function toggleMenuSpan(e) {
   
   // ownProps.handleFrameUpdate({menuSpanVisibility:ownProps.menuSpanVisibility});
  
     // e.preventDefault();
      dispatch((0, _content.changeMenuSpanVisibility)(ownProps.reduxUid, ownProps.id, ownProps.trace, !ownProps.menuSpanVisibility));
    },
