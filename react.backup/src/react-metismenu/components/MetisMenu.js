...
var MetisMenu = function (_React$Component) {
  ...
  function MetisMenu(props) {
    ...
    _this.handleFrameUpdate = props.handleFrameUpdate;
    _this.menuSpanVisibility=props.menuSpanVisibility;
    ...
    value: function render() {
      var mainWrapper = _react2.default.createElement(
        ...
        _react2.default.createElement(_Container2.default, {
          ...
          handleFrameUpdate: this.handleFrameUpdate,  
          menuSpanVisibility: this.state.menuSpanVisibility,
